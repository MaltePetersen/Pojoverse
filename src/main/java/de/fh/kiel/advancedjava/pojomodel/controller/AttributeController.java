...
public class AttributeController {
    ...
    public ResponseEntity<Pojo> addAttribute( @Parameter(name="Classname", description = "including the packagename") @PathVariable String className, @RequestBody AddAttributeDTO addAttributeDTO) {
