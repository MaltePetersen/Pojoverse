...
public class PojosController {
    ...
    @Operation(summary = "Base64 Jar-Upload", description = """
            On this endpoint the user can upload base64 encoded Jar. 
    ...
    @Operation(summary = "Import an ExportDTO", description = """
            On this endpoint the user can import with an ExportDTO. Caution:
    ...
    @Operation(summary = "Multipart Jar-Upload", description ="""
                    This endpoint the user can upload a jar.
    ...
    @Operation(summary = "Get all pojos and packages", description = """
                      This endpoint returns an exportDTO including all pojos and packages. 
